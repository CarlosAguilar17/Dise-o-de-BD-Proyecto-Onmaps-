Public Class frmNuevoParticipante
    Public Sub inicializarPantalla()
        ...
        txtMaterno.Clear()
        'txtSede.Clear()
        llenaCombo("Select idSede, Nombre from Sede", cboSede, "idSede", "Nombre", sqlConexion)
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        sqlcmdComando.CommandText = "SP_Participante 1, 0, '" & txtGrado.Text & "','" & txtNombre.Text & "','" & txtPaterno.Text & "','" & txtMaterno.Text & "'," & cboSede.SelectedValue
    ...
    Private Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        If MessageBox.Show("Seguro que deseas modificar el registro?", "Atencion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            Dim sqlcmdComando As New SqlClient.SqlCommand
            sqlcmdComando.CommandText = "SP_Participante 3, '" & txtIdParticipante.Text & "', '" & txtGrado.Text & "','" & txtNombre.Text & "','" & txtPaterno.Text & "','" & txtMaterno.Text & "'," & cboSede.SelectedValue
            sqlcmdComando.Connection = sqlConexion
            sqlcmdComando.ExecuteNonQuery()
    ...
    Private Sub cboSede_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboSede.SelectedIndexChanged
