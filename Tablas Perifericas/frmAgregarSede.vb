Public Class frmAgregarSede
    Public Sub inicializarPantalla()
        ...
        txtCalle.Clear()
        txtNumExt.Clear()
        llenaCombo("Select idCiudad, Nombre as Ciudad from Ciudad", cboCiudad, "idCiudad", "Ciudad", sqlConexion)
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        sqlcmdComando.CommandText = "SP_Sede 1,0," & cboCiudad.SelectedValue & ",'" & txtNombre.Text & "','" & txtCalle.Text & "','" & txtColonia.Text & "','" & txtNumExt.Text & "'"
    ...
    Private Sub btnModificar_Click(sender As Object, e As EventArgs) Handles btnModificar.Click
        If MessageBox.Show("Seguro que deseas modificar el registro?", "Atencion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            Dim sqlcmdComando As New SqlClient.SqlCommand
            sqlcmdComando.CommandText = "SP_Sede 3," & txtIdSede.Text & "," & cboCiudad.SelectedValue & ",'" & txtNombre.Text & "','" & txtCalle.Text & "','" & txtColonia.Text & "','" & txtNumExt.Text & "'"
            sqlcmdComando.Connection = sqlConexion
            sqlcmdComando.ExecuteNonQuery()
